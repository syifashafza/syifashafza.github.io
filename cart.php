...
<section class="shopping-cart">
   ...
   <h1 class="title">film yang anda pilih</h1>
   ...
   <div class="cart-total">
      ...
      <div class="flex">
         <a href="shop.php" class="option-btn">beli tiket lagi</a>
         <a href="checkout.php" class="btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">checkout sekarang</a>
      </div>
   </div>
